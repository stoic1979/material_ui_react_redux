...
const UserList = () => {
  const columns = [
    ...
    {id: 0, title: 'Name', prop: 'first_name', width: '10%', headerClass: 'mdl-data-table__cell--non-numeric', cellClass: 'mdl-data-table__cell--non-numeric'},
    {id: 1, title: 'User name', prop: 'last_name', width: '10%', headerClass: 'mdl-data-table__cell--non-numeric', cellClass: 'mdl-data-table__cell--non-numeric'},
    ...
    {id: 5, title: 'Security Level', prop: 'country.code', width: '10%', headerClass: 'mdl-data-table__cell--non-numeric', cellClass: 'mdl-data-table__cell--non-numeric'},
    {id: 6, title: 'Primary Contact', render: CheckBtn, width: '5%', headerClass: 'mdl-data-table__cell--non-numeric', cellClass: 'mdl-data-table__cell--non-numeric'},
  ...
  return (
    <div>
      <h3 style={globalStyles.navigation}> User List</h3>
      <Row>
